                        ...
                        <Row className="align-items-center">
                            <div className="d-flex flex-column align-items-start justify-content-center">
                                ...
                                <motion.div variants={{ hidden: { opacity: 0 }, show: { opacity: 1, transition: { staggerChildren: 0.25 } } }} initial="hidden" animate="show" className="links details contiainer py-4 my-3">
                                    ...
                                    <Link to="https://drive.google.com/file/d/1LIojPHtw51QA0ubf2D1JH0diysewHBVw/view?usp=sharing" target="_blank"><motion.i variants={{ hidden: { opacity: 0 }, show: { opacity: 1 } }} className="bi bi-file-earmark-person px-2"></motion.i></Link>
                                </motion.div>
                            </div>
                        </Row>
                    </Col>
