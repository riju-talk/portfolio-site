    ...
    return (
        <div>
            ...
            <Row className="grid gap-0 column-gap-5">
                ...
                <Col className="container-fluid align-items-center"><Image src={image} style={{border: "#83a79c"}} className="object-fit-cover border rounded border-image ratio ratio-4x3" fluid/></Col>
            </Row>
            <Row></Row>
            </Container>
        </div>
