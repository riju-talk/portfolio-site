...
function Project() {
    return (
        <div>
            <h1><TypeAnimation sequence={["Projects,"]}/></h1>
                ...
                <div className="row">
                    <div className="col-3">
                        <nav id="navbar-example3" class="h-100 flex-column align-items-stretch pe-4 border-end">
                            <nav className="nav nav-pills flex-column container">
                    ...
                    <div className="col-7">
                        <div data-bs-spy="scroll" data-bs-target="#navbar-example3" data-bs-smooth-scroll="true" className="layout" tabindex="0">
                            <div id="item-1" className="project-item">
                                ...
                                <p><a class="link-opacity-75-hover text-color" href="https://github.com/riju-talk/portfolio-site">Visit The Repo <i class="bi bi-box-arrow-up-right text-color"></i></a></p>
                            </div>
                            <div id="item-2" className="project-item">
                                ...
                                <p><a class="link-opacity-75-hover text-color" href="https://github.com/rijusmit22400/flutter_app">Visit The Repo <i class="bi bi-box-arrow-up-right text-color"></i></a></p>
                            </div>
                            <div id="item-3" className="project-item">
                                ...
                                <p><a class="link-opacity-75-hover text-color" href="https://github.com/riju-talk/sign_lang">Visit The Repo <i class="bi bi-box-arrow-up-right text-color"></i></a></p>
                            </div>
                            <div id="item-4" className="project-item">
                                ...
                                <p><a class="link-opacity-75-hover text-color" href="https://github.com/rijusmit22400/DBMS_Proj_sem4">Visit The Repo <i class="bi bi-box-arrow-up-right text-color"></i></a></p>
                            </div>
                            <div id="item-5" className="project-item">
                                ...
                                <p><a class="link-opacity-75-hover text-color" href="https://github.com/Ramanjs/ecell">Visit The Repo <i class="bi bi-box-arrow-up-right text-color"></i></a></p>
                            </div>
                            <div id="item-6" className="project-item">
                                ...
                                <p><a class="link-opacity-75-hover text-color" href="https://github.com/riju-talk/shell_scripts">Visit The Repo <i class="bi bi-box-arrow-up-right text-color"></i></a></p>
                            </div>
                            <div id="item-7" className="project-item">
                                ...
                                <p><a class="link-opacity-75-hover text-color" href="https://github.com/riju-talk/stick_hero_clone">Visit The Repo <i class="bi bi-box-arrow-up-right text-color"></i></a></p>
                            </div>
                        </div>
                    </div>
                </div>
