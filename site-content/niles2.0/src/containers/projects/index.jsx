                    ...
                    <div class="col-3">
                        <nav id="navbar-example3" class="h-100 flex-column align-items-stretch pe-4 border-end">
                            <nav class="nav nav-pills flex-column">
                                <a class="text-color" href="#item-1">This Website</a>
                                <a class="text-color" href="#item-2">Notes Android App</a>
                                <a class="text-color" href="#item-3">Sign Language Classifier</a>
                                <a class="text-color" href="#item-4">E-Commerce Website</a>
                                <a class="text-color" href="#item-5">Shell Scripts</a>
                                <a class="text-color" href="#item-6">Stick Hero</a>
                                <a class="text-color" href="#item-7">Node.Js APIs</a>
                                <a class="text-color" href="#item-8">AI Chatbot</a>
                            </nav>
                        </nav>
                    </div>
                    <div class="col-7">
                        <div data-bs-spy="scroll" data-bs-target="#navbar-example3" data-bs-smooth-scroll="true" className="layout" tabindex="0">
                            <div id="item-1" className="project-item">
                                <h4 className="title-color">This Website</h4>
                            ...
                            <div id="item-2" className="project-item">
                                <h4 className="title-color">Note Taking and List Making App</h4>
                            ...
                            <div id="item-3" className="project-item">
                                <h4 className="title-color">Sign Language Classifier.</h4>
                            ...
                            <div id="item-4" className="project-item">
                                <h4 className="title-color">E-Commerce Website KRSR</h4>
                            ...
                            <div id="item-5" className="project-item">
                                <h4 className="title-color">E-Cell IIT-Delhi Website</h4>
                            ...
                            <div id="item-6" className="project-item">
                                <h4 className="title-color">Group of Shell-Scripts</h4>
                            ...
                            <div id="item-7" className="project-item">
                                <h4 className="title-color">Stick Hero Game</h4>
